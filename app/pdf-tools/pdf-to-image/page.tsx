...
export default function PdfToImagePage() {
  const title = "PDF to Image";
  const instructions = "Upload a PDF file to convert its pages into high-quality JPEG or PNG images.";
  const gradient = "from-brand-500 to-red-600";
