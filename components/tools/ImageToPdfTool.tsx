...
export default function ImageToPdfTool() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-slate-800/50 border border-slate-700/50 p-6 rounded-2xl flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-3">
            <label className="text-sm font-medium text-slate-300">Page Orientation</label>
          ...
          <div className="flex flex-col gap-3">
            ...
            <select
              ...
              className="w-full bg-slate-800 border border-slate-700 text-slate-300 text-sm rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all cursor-pointer appearance-none"
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="sr-only"
                />
                <div className={`w-11 h-6 bg-slate-700 rounded-full transition-colors duration-300 ${merge ? "bg-blue-500" : ""}`}></div>
